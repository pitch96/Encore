            ...
            if (jQuery('#widgetChart1').length > 0) {
                ...
                new Chart(chart_widget_1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: "Sales Stats",
                            backgroundColor: ['rgba(230, 11, 125, 0.1)'],
                            borderColor: '#E60B7D',
                            pointBackgroundColor: '#e60b7d',
                ...
                new Chart(widgetChart2, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderColor: '#13B497',
                            borderWidth: "0",
                            backgroundColor: ['#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', '#F08EA9', '#E60B7D', ],
                ...
                var config = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            pointHoverBackgroundColor: 'rgb(230 11 125)',
                            pointBorderWidth: 30,
                            pointHoverRadius: 10,
                        }]
                    },
            ...
            var optionsTimeline = {
                ...
                plotOptions: {
                    bar: {
                        ...
                        colors: {
                            backgroundBarColors: ['#3b444e', '#3b444e', '#3b444e', '#3b444e', '#3b444e', '#3b444e', '#3b444e', '#3b444e'],
                    ...
                    new Chart(lineChart_4, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                borderColor: 'rgba(236, 22, 127, 1)',
                                borderWidth: "2",
                                backgroundColor: 'transparent',
                                pointBackgroundColor: 'rgb(230 11 125)'
                            }, {
                                label: "My First dataset",
