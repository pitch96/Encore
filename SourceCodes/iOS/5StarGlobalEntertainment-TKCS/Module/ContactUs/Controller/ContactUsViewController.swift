...
class ContactUsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        descriptionTextView.text = "Type your query..."
    ...
    @IBAction func contactUsButtonAction(_ sender: UIButton) {
        ...
        if let alertmessage = alertmessage{
            ...
            contactUsViewModel.callContactUsApi(name: nameTextField.text ?? "", email: emailTextField.text ?? "", phoneNum: phoneTextField.text ?? "", query: descriptionTextView.text ?? "") { ContactusData, isSuccess in
                if isSuccess == true{
                    ...
                    self.showSimpleAlert(message: ContactusData?.message ?? DefaultValue.emptyString.rawValue)
                }
