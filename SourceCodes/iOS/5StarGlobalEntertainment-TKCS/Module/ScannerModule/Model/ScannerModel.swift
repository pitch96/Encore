...
import Foundation
// MARK: Scanner Model
struct ScannerDetailModel: Codable {
    var statusCode: Int?
    var success: Bool?
    var message: String?
    var data: ScannedDetails?
}

// MARK: - ScannedDetails
struct ScannedDetails: Codable {
    var id, orderID: Int?
    var ticketNo: String?
    var isChecked: Int?
    var createdAt, updatedAt: String?
    var orderData: ScannedOrderData?
...
// MARK: - OrderData
struct ScannedOrderData: Codable {
    var id: Int?
    var orderDetails: ScannedOrderDetails?
...
// MARK: - OrderDetails
struct ScannedOrderDetails: Codable {
    var eventID: Int?
